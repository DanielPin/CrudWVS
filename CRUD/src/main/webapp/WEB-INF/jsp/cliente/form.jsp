	...
	<form action="${linkTo[ClienteController].adiciona(null) }"
		...
		<div class="form-row">
			<div class="form-group col-md-6">
				<label for="nome">NOMEá:</label> <input type="text"
					name="cliente.nome" id="nome" class="form-control"
					value="${cliente.nome}" placeholder="Nome completo" />
			</div>

			<div class="form-group col-md-6">
				<label for="cpf">CPF:</label> <input type="text" name="cliente.cpf"
					id="cpf" class="form-control" value="${cliente.cpf}"
					placeholder="000.000.000-00" />
			</div>

			<div class="form-group col-md-6">
				<label for="rg">RG:</label> <input type="text" name="cliente.rg"
					id="rg" class="form-control" value="${cliente.rg}"
			...
			<div class="form-group col-md-6">
				<label for="email">E-MAIL:</label> <input type="text"
					...
					value="${cliente.email}" placeholder="Digite um e-mail" />
			</div>
			...
			<div class="form-group col-md-6">
				<label for="celular">CELULAR:</label> <input type="text"
					name="cliente.celular" id="celular" class="form-control"
					value="${cliente.celular}" placeholder="(00)(00000-0000)" />
			</div>

			<div class="form-group col-md-6">
				<label for="rua">RUA:</label> <input type="text" name="cliente.rua"
					id="rua" class="form-control" value="${cliente.rua}"
					placeholder="Rua com numero da residencia" />
			</div>

			<div class="form-group col-md-6">
				<label for="bairro">BAIRRO:</label> <input type="text"
					name="cliente.bairro" id="bairro" class="form-control"
					value="${cliente.bairro}" />
			</div>

			<div class="form-group col-md-6">
				<label for="cep">CEP:</label> <input type="text" name="cliente.cep"
					id="cep" class="form-control" value="${cliente.cep}"
