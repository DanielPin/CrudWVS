...
<div id="tamanho_lista">
	<a class="btn btn-secondary btn-lg"
		href="${linkTo[ClienteController].form()}">Novo cliente</a>
							...
							<div class="modal fade" id="modalExemplo" tabindex="-1"
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">Deseja realmente deletar o usuario(a): ${cliente.nome} ?</div>									
										<div class="modal-footer">
											<button type="button" class="btn btn-primary"
												data-dismiss="modal" onclick="msg()">Cancelar</button>
...
<!-- 								<input	type="submit" value="Excluir" onclick=""> -->
						</form>
					</td>
